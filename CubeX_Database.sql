...
SELECT NAME_USER, LEVEL_USER, ROLE_USER, REGISTRATION_DATE FROM CUBE_USERS WHERE MAIL = 'a@gmail.com';
SELECT ID_USER FROM CUBE_USERS WHERE MAIL = 'eljoaki@gmail.com';
...
CREATE TABLE SESSIONS (
    ...
    SELECT * FROM CUBE_TYPE WHERE ID_TYPE = 2;
    SELECT * FROM SESSIONS WHERE ID_USER = (SELECT ID_USER FROM CUBE_USERS WHERE MAIL = 'eljoaki@gmail.com');
    SELECT MIN(ID_SESSION) FROM SESSIONS WHERE ID_USER = (SELECT ID_USER FROM CUBE_USERS WHERE MAIL = 'eljoaki@gmail.com');
    SELECT MIN(ID_SESSION) FROM SESSIONS WHERE ID_USER = (SELECT ID_USER FROM CUBE_USERS WHERE MAIL = 'eljoaki@gmail.com');
    SELECT ID_TYPE FROM CUBE_TYPE WHERE NAME_TYPE = '3x3x3';
...
CREATE TABLE AVERAGE (
    ...
    CONSTRAINT fk_user_average FOREIGN KEY (ID_USER) REFERENCES CUBE_USERS(ID_USER),
    CONSTRAINT fk_type_average FOREIGN KEY (ID_TYPE) REFERENCES CUBE_TYPE(ID_TYPE)
);
...
CREATE TABLE TIMES_COMPETITION(
    ...
    CONSTRAINT fk_compe_user FOREIGN KEY (ID_USER) REFERENCES CUBE_USERS(ID_USER),
