...
INSERT INTO CUBE_USERES (NAME_USER, PASSWORD_USER, MAIL, REGISTRATION_DATE) 
	VALUES ('admin', 'admin', 'admin@admin.com', '2024-04-25'); -- USUARIO POR DEFECTO
...
/**GENERAR UNA SESION POR DEFECTO CADA VEZ QUE UN USUARIO CREA UNA CUENTA*/
INSERT INTO SESSIONS (ID_USER, NAME_SESSION, CREATION_DATE) 
	VALUES (1, 'GENERAL', ()); 

SELECT REGISTRATION_DATE 
FROM CUBE_USERS C, SESSIONS S 
WHERE S.ID_USER = C.ID_USER;
...
CREATE TABLE CHAMPIONSHIP (
    ...
    -- PONGO LA FECHA EN LAS COMPETICIONES (?)    
    REGISTRATION_DATE DATE NOT NULL,
